...
public class HQPlayerListVar  implements Serializable,Cloneable{
	...
	public HQPlayerListVar(HQPlayerVarModel playerVarModel){
...
//			throw new ModelErrorException("model is error to create HQPlayerListVar , got type "+playerVarModel.getVarType()+
//					",but need type 1");
	}
