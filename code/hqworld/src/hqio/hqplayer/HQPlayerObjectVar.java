...
public class HQPlayerObjectVar  implements Serializable,Cloneable{
	...
	public HQPlayerObjectVar(HQPlayerVarModel playerVarModel) throws HQModelErrorException{
		this(playerVarModel.getVarName(),playerVarModel.getTableName(),new HQRecord(playerVarModel));
		if(playerVarModel.getVarType()!=2)
			throw new HQModelErrorException("model is error to create HQPlayerObjectVar , got type "+playerVarModel.getVarType()+
					",but need type 2");
	}
	@Override
